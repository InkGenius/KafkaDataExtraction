...
public class MutilDataSourcekafkaProducer extends Thread {

    private List<Topics> topicList;
    private List<DataSource> dataSources;
    private List<BufferedReader> readers;
    public MutilDataSourcekafkaProducer(List<Topics> topicList){    
	...
	public static void main(String[] args) {
		...
		new MutilDataSourcekafkaProducer(topicList).start();
	}
